...
login = 'fagbotservices@gmail.com'; password = [redacted]
...
with logined(login, password, smtp_host) as smtp_serv:
    for i in range(email_count):
        ...
        msg['From'] = login
        msg['To'] = reciever
        msg['Subject'] = "Daily Faggotry"
        plain = 'Faggot.\r\n\r\nFaggot Bot is a programming experiment by a novice programmer, used to help learn some basic coding.  Your email will never be sold or used for any other purpose other than this service.'
        html = '''\
        <html>
            <head></head>
            <body>
                <p>Faggot.<br>
                <br>
                <font size=1><i>Faggot Bot is a programming experiment by a novice programmer, used to help learn some basic coding.<br>
